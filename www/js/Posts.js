            ...
            return $q(function(resolve, reject) {
              var newPost = {
                  ...
                  user: {
                      ...
                      profileImageSmall: "http://img.wennermedia.com/article-leads-vertical-300/1251226976_julia_roberts_290x402.jpg"
                  },
                  image: imageUri,
          ...
          return $q(function(resolve, reject){
            var newcomment = {
                ...
                user: {
                    id: loguserid,
                    username: logusername,
                    profileImageSmall: "http://vignette2.wikia.nocookie.net/harrypotter/images/0/00/Harry_James_Potter34.jpg/revision/latest?cb=20150826224904"
                },
                text: comment,
                userRefs: [],
                tags: []
